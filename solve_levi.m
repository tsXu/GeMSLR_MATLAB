function [ y ] = solve_levi( PRE, x, levi )
%[ y ] = solve_levi( PRE, x, levi )
%   Apply a solve with levi matrix
...
% low-rank update
zC = zC + PRE.Levs{levi}.Z*(PRE.Levs{levi}.G*(PRE.Levs{levi}.Y'*zC));
% solve with C
yC = solve_levi( PRE, zC, levi + 1 );
